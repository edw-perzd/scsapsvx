...
<x-app-layout>
    <!-- CUERPO DE USUARIOS DEL SISTEMA -->
    <div class="container-md py-4">
        <h1 class="display-6 text-center">Usuarios del sistema</h1>
        <!-- FORMULARIO DE BÚSQUEDA -->
        <form class="row justify-content-center mt-4" action="{{route('admin.users.index')}}" method="GET">
            <div class="col-8 col-sm-5">
                <input class="form-control" type="text" name="searchUser" id="searchUser" placeholder="Ingresa nombre">
            </div>
